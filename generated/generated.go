...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Listener.createdAt":
		if e.complexity.Listener.CreatedAt == nil {
			break
		}

		return e.complexity.Listener.CreatedAt(childComplexity), true

	case "Listener.followed":
		if e.complexity.Listener.Followed == nil {
			break
		}

		return e.complexity.Listener.Followed(childComplexity), true
	...
	case "Listener.updatedAt":
		if e.complexity.Listener.UpdatedAt == nil {
			break
		}

		return e.complexity.Listener.UpdatedAt(childComplexity), true

	case "Mutation.addListener":
		if e.complexity.Mutation.AddListener == nil {
			break
		}
	...
	case "Query.liteners":
		...
		return e.complexity.Query.Liteners(childComplexity), true
...
func (ec *executionContext) _Mutation_addListener(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
...
func (ec *executionContext) _Query_liteners(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().Liteners(rctx)
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Mutation(ctx context.Context, sel ast.SelectionSet) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "addListener":
			out.Values[i] = ec._Mutation_addListener(ctx, field)
			if out.Values[i] == graphql.Null {
				invalids++
			}
		default:
	...
	for i, field := range fields {
		...
		case "liteners":
			...
			out.Concurrently(i, func() (res graphql.Marshaler) {
				...
				res = ec._Query_liteners(ctx, field)
				if res == graphql.Null {
					atomic.AddUint32(&invalids, 1)
				}
				return res
